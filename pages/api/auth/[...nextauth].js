    ...
    async jwt({token, account , user}){
      ...
      if(account && user ){
          return {
            ...
            accessTokenExpires:account.expires_at * 1000, //we are handling expiries times in Milliseconds hence * 1000 
          }
      }
    // Return the prevouse token if access token has not expired
